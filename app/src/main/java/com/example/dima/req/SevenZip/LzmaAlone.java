...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			com.example.dima.req.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				com.example.dima.req.SevenZip.Compression.LZMA.Encoder encoder = new com.example.dima.req.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				com.example.dima.req.SevenZip.Compression.LZMA.Decoder decoder = new com.example.dima.req.SevenZip.Compression.LZMA.Decoder();
